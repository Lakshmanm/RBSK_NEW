...
public class TableMainLayout extends RelativeLayout {
	...
	String headers[] = { "HealthCondition 1", "HealthCondition 2",
			"HealthCondition 3", "HealthCondition 4", "HealthCondition 5",
			"HealthCondition 6", "HealthCondition 7", "HealthCondition 8",
			"HealthCondition 9", "HealthCondition 10" };
	String[] data = new String[] { "2014,Round2", "2014,Round1", "2014,Round1",
			"2013,round2", "5", "6", "7", "8", "9", "10" };
	...
	private void addComponentToMainLayout() {
		...
		RelativeLayout.LayoutParams componentB_Params = new RelativeLayout.LayoutParams(1100,LayoutParams.MATCH_PARENT);
	...
	private void generateTableC_AndTable_B() {
		...
		for (int i = 0; i < data.length; i++) {
			...
			TableRow tableRowForTableC = this.tableRowForTableC(data[i]);
			TableRow taleRowForTableD = this.taleRowForTableD(1);// Pass values
																	// of Image
																	// that has
																	// to be
																	// displayed
	...
	TableRow tableRowForTableC(String data) {
		...
		TextView textView = this.bodyTextView(data);
	...
	TableRow taleRowForTableD(int num) {
		...
		for (int x = 0; x < loopCount; x++) {
			...
			taleRowForTableD.addView(iv, params);
		}
	...
	class MyHorizontalScrollView extends HorizontalScrollView {
		...
		protected void onScrollChanged(int l, int t, int oldl, int oldt) {
			...
			if (StringUtils.equalsNoCase(tag,"horizontal scroll view b")) {
	...
	class MyScrollView extends ScrollView {
		...
		protected void onScrollChanged(int l, int t, int oldl, int oldt) {
			...
			if (StringUtils.equalsNoCase(tag,"scroll view c")) {
